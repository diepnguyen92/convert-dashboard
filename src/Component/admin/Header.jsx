...
import youtobe from '../../assets/images/social/youtube.png'
import smiling from '../../assets/images/medium-shot-happy-man-smiling.jpg'
                ...
                <div className="container">
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-md-4 col-4">
                      <Link className="dropdown-item text-center" to="#">
                        <img
                          src={spotify}                          className="profile-image img-fluid"
                          alt=""
                        />
